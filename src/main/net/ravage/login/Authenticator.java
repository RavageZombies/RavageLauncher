...
import net.ravage.login.model.request.InvalidateRequest;
import net.ravage.login.model.request.SignoutRequest;
import net.ravage.login.model.request.ValidateRequest;
import net.ravage.login.model.request.RefreshRequest;
import net.ravage.login.model.response.RefreshResponse;
import net.ravage.login.model.request.AuthRequest;
import net.ravage.login.model.response.AuthResponse;
import net.ravage.login.model.AuthAgent;

public class Authenticator
{
    public static String MOJANG_AUTH_URL = "https://authserver.mojang.com/";
